...
class GameIntroView extends GetView<GameIntroController> {
  const GameIntroView({Key? key}) : super(key: key);
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: SectionHeaderView(
                label: LocaleKeys.game_intro_title.tr,
                subtitle: '',
                labelSize: 26.0,
