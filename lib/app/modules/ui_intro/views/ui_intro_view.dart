...
class UiIntroView extends GetView<UiIntroController> {
  const UiIntroView({Key? key}) : super(key: key);
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: SectionHeaderView(
                label: LocaleKeys.ui_intro_title.tr,
                subtitle: '',
                labelSize: 26.0,
