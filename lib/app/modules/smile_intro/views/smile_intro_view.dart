...
class SmileIntroView extends GetView<SmileIntroController> {
  const SmileIntroView({Key? key}) : super(key: key);
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: SectionHeaderView(
                label: LocaleKeys.smile_intro_title.tr,
                subtitle: '',
                labelSize: 26.0,
          ...
          Expanded(
            child: Container(
              ...
              child: Center(
                child: Text(
                  LocaleKeys.smile_intro_body.tr,
