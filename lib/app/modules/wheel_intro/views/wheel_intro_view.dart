...
class WheelIntroView extends GetView<WheelIntroController> {
  const WheelIntroView({Key? key}) : super(key: key);
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: SectionHeaderView(
                label: LocaleKeys.wheel_intro_title.tr,
                subtitle: '',
                labelSize: 26.0,
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Container(
                ...
                child: Center(
                  child: Text(
                    LocaleKeys.wheel_intro_body.tr,
                    style: TextStyle(fontSize: 16, color: HexColor("#817142")),
                  ),
                ),
              ),
            ),
