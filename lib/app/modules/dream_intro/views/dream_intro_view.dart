...
class DreamIntroView extends GetView<DreamIntroController> {
  const DreamIntroView({Key? key}) : super(key: key);
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: SectionHeaderView(
                label: LocaleKeys.dream_intro_title.tr,
                subtitle: '',
                labelSize: 26.0,
          ...
          Expanded(
            child: Container(
              ...
              child: Center(
                child: Text(
                  LocaleKeys.dream_intro_body.tr,
